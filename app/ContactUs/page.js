...
const page = () => {
  ...
  return (
    <>
      <Navbar />
      <div className="max-w-5xl max-lg:max-w-3xl mx-auto bg-white my-6 font-[sans-serif] mt-32">
        ...
        <div className="grid lg:grid-cols-3 items-start gap-4 p-2 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-lg mt-12">
          <div className="bg-[#011c2b] rounded-lg p-6 h-full max-lg:order-1 bg-gradient-to-r from-blue-700 to-[#B06AB3]">
            <h2 className="text-xl text-white">Contact Information</h2>
            <p className="text-sm text-gray-300 mt-4"> Let's keep in touch!</p>
            ...
            <ul className="flex flex-wrap gap-4 mt-16">
              <li className="bg-gray-800 hover:bg-gray-900 h-10 w-10 rounded-full flex items-center justify-center shrink-0 bg-gradient-to-r from-blue-700 to-[#B06AB3]">
          ...
          <div className="p-4 lg:col-span-2">
            <form onSubmit={handleSubmit}>
                  ...
                  <div className="flex max-lg:flex-col gap-6 mt-4">
                    {[
                      ...
                      <div key={index} className="flex items-center">
                        ...
                        <p className="text-sm text-gray-500 ml-4">{subject}</p>
                      </div>
                    ))}
                  </div>
                </div>
              ...
              <button
                type="submit"
                className="mt-12 flex items-center justify-center text-sm lg:ml-auto max-lg:w-full rounded-lg px-4 py-3 tracking-wide text-white bg-blue-600 hover:bg-blue-700 bg-gradient-to-r from-blue-700 to-[#B06AB3]"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16px"
