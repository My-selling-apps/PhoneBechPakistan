...
const SuccessModal = ({ isOpen, onClose }) => {
  ...
  return (
    <div id="successModal" tabIndex="-1" aria-hidden="true" className="overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-modal md:h-full flex bg-black bg-opacity-50">
      <div className="relative p-4 w-full max-w-md h-full md:h-auto">
        <div className="relative p-4 text-center bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
          ...
          <p className="mb-4 text-lg font-semibold text-gray-900 dark:text-white">Your Ad Has Been Posted Successfully</p>
          <button
            onClick={onClose}
            type="button"
